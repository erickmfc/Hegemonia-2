...
// Bloco 4, Fase 4: Unidade Pronta! (SISTEMA MÚTIPLO)
// =========================================================
...
// Criar unidade conforme tipo solicitado
var _obj_unidade = obj_infantaria;
if (variable_instance_exists(id, "ultimo_recrutamento_tanque") && ultimo_recrutamento_tanque) {
    _obj_unidade = obj_tanque;
}
