...
if (mouse_check_button_pressed(mb_right)) {
    if (!selecionado) {
        show_debug_message("❌ FRAGATA NÃO SELECIONADA - Clique esquerdo primeiro!");
        exit;
    }
    ...
    show_debug_message("🚢 Fragata movendo para: (" + string(destino_x) + ", " + string(destino_y) + ")");
}
