...
// --- 4. MÁQUINA DE ESTADOS PRINCIPAL (MOVIMENTO SIMPLIFICADO) ---
switch (estado) {
    // ==========================================================
    // ESTADO: MOVENDO
    // ==========================================================
...
if (variable_global_exists("game_frame") && global.game_frame % 5 == 0) {
    ...
    if (_script_index != -1 && asset_get_type(_script_index) == asset_script) {
        ...
        scr_colisao_fisica_unidades(id, 50, 1.2); // Raio maior para navios (são muito maiores)
    }
