// ===============================================
// HEGEMONIA GLOBAL - CAÇA F-5 (Draw Refatorado)
// ===============================================
...
if (selecionado) {
    ...
    // ✅ Área de mira do F-35 (dobrada e transparente)
    if (variable_instance_exists(id, "alcance_ataque")) {
        var _alcance_mira = alcance_ataque * 2; // ✅ Dobrar o alcance
        draw_set_color(c_yellow);
        draw_set_alpha(0.1); // ✅ Transparente
        draw_circle(x, _draw_y, _alcance_mira, false);
        draw_set_alpha(0.15); // ✅ Borda um pouco mais visível
        draw_circle(x, _draw_y, _alcance_mira, true);
    }
    ...
    // Indicadores de seleção apenas (radar e círculo de seleção)
    // A rota de patrulha foi movida para fora deste bloco para ficar sempre visível
