/// @description Colisão com Soldado Antiaéreo - Quartel
// =============================================
// HEGEMONIA GLOBAL - SISTEMA DE COLISÃO FÍSICA
// =============================================

// === COLISÃO COM SOLDADO ANTIAÉREO ===
...
if (instance_exists(other)) { 
    ...
    if (_deve_respeitar) {
        show_debug_message("🚫 Colisão detectada: Soldado Antiaéreo vs Quartel");
        ...
        if (_distancia < 32) {
            ...
            if (!position_meeting(_novo_x, _novo_y, obj_quartel)) {
                other.x = _novo_x;
                other.y = _novo_y;
                show_debug_message("📍 Soldado Antiaéreo empurrado para: (" + string(_novo_x) + ", " + string(_novo_y) + ")");
            }
        }
    }
}
