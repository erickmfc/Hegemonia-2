/// @description Colisão com Soldado Antiaéreo - Fazenda
// =============================================
...
if (instance_exists(other)) { 
    ...
    if (_deve_respeitar) {
        show_debug_message("🚫 Colisão detectada: Soldado Antiaéreo vs Fazenda");
        ...
        if (_distancia < 32) {
            ...
            if (!position_meeting(_novo_x, _novo_y, obj_fazenda)) {
                other.x = _novo_x;
                other.y = _novo_y;
