/// @description Colisão com Infantaria - Fazenda
// =============================================
// HEGEMONIA GLOBAL - SISTEMA DE COLISÃO FÍSICA
// =============================================

// === COLISÃO COM INFANTARIA ===
// Simplificado: sempre respeitar colisão para unidades terrestres
if (instance_exists(other)) {
    ...
    if (_deve_respeitar) {
        show_debug_message("🚫 Colisão detectada: Infantaria vs Fazenda");
