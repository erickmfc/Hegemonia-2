...
if (mostrar_menu) {
    ...
    // === UNIDADE PRINCIPAL (INFANTARIA) ===
    var _unidades_y = _info_y + _info_h + 20;
    var _unidade_h = 60;
    var unidade_infantaria = ds_list_find_value(unidades_disponiveis, 0); // Primeira unidade (Infantaria)
    
    // Background da unidade
    draw_set_color(make_color_rgb(50, 70, 90));
    draw_set_alpha(0.9);
    draw_roundrect_ext(_menu_x + 25, _unidades_y, _menu_x + 25 + _info_w, _unidades_y + _unidade_h, 8, 8, false);
    
    // Borda da unidade
    draw_set_color(make_color_rgb(100, 180, 255));
    draw_set_alpha(0.7);
    draw_roundrect_ext(_menu_x + 25, _unidades_y, _menu_x + 25 + _info_w, _unidades_y + _unidade_h, 8, 8, true);
    
    // Nome da unidade
    draw_set_halign(fa_left);
    draw_set_valign(fa_top);
    draw_set_color(c_white);
    draw_text_transformed(_menu_x + 35, _unidades_y + 10, unidade_infantaria.nome, 0.9, 0.9, 0);
    
    // Custo e tempo
    draw_set_color(make_color_rgb(255, 215, 0));
    draw_text_transformed(_menu_x + 35, _unidades_y + 30, "$" + string(unidade_infantaria.custo_dinheiro) + " | " + string(unidade_infantaria.custo_populacao) + " pop | " + string(unidade_infantaria.tempo_treino/60) + "s", 0.8, 0.8, 0);
    
    // Descrição
    draw_set_color(make_color_rgb(180, 200, 220));
    draw_text_transformed(_menu_x + 35, _unidades_y + 45, unidade_infantaria.descricao, 0.75, 0.75, 0);
    
    // === BOTÕES DE QUANTIDADE ===
    var _botoes_y = _unidades_y + _unidade_h + 20;
    var _botao_qtd_w = 80;
    var _botao_qtd_h = 40;
    ...
    // === TANQUE DE GUERRA ===
    var _tanque_y = _botoes_y + _botao_qtd_h + 20;
    var unidade_tanque = ds_list_find_value(unidades_disponiveis, 3); // Quarta unidade (Tanque)
    
    // Background do tanque
    draw_set_color(make_color_rgb(40, 50, 70));
    draw_set_alpha(0.9);
    draw_roundrect_ext(_menu_x + 25, _tanque_y, _menu_x + 25 + _info_w, _tanque_y + _unidade_h, 8, 8, false);
    
    // Borda do tanque
    draw_set_color(make_color_rgb(70, 100, 140));
    draw_set_alpha(0.7);
    draw_roundrect_ext(_menu_x + 25, _tanque_y, _menu_x + 25 + _info_w, _tanque_y + _unidade_h, 8, 8, true);
    
    // Nome do tanque
    draw_set_halign(fa_left);
    draw_set_valign(fa_top);
    draw_set_color(c_white);
    draw_text_transformed(_menu_x + 35, _tanque_y + 10, unidade_tanque.nome, 0.9, 0.9, 0);
    
    // Custo e tempo do tanque
    draw_set_color(make_color_rgb(255, 215, 0));
    draw_text_transformed(_menu_x + 35, _tanque_y + 30, "$" + string(unidade_tanque.custo_dinheiro) + " | " + string(unidade_tanque.custo_populacao) + " pop | " + string(unidade_tanque.tempo_treino/60) + "s", 0.8, 0.8, 0);
    
    // Descrição do tanque
    draw_set_color(make_color_rgb(180, 200, 220));
    draw_text_transformed(_menu_x + 35, _tanque_y + 45, unidade_tanque.descricao, 0.75, 0.75, 0);
    
    // === STATUS DE RECRUTAMENTO ===
    var _status_x = _info_x;
    var _status_y = _tanque_y + _unidade_h + 20;
