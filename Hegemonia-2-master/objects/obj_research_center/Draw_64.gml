...
// === MAIN CONTAINER - DESIGN MODERNO (DIMENSÕES AJUSTADAS) ===
...
scr_desenhar_texto_ui(container_x + container_w/2, header_y + 20, "CENTRO DE PESQUISA TECNOLÓGICA", 1.2, 1.2);

// Subtítulo
draw_set_color(make_color_rgb(180, 200, 220));
scr_desenhar_texto_ui(container_x + container_w/2, header_y + 40 + (header_h * 0.07), "Desenvolva novas tecnologias para expandir seu império", 0.85, 0.85);
...
scr_desenhar_texto_ui(info_panel_x + 15, info_panel_y + 15, "RECURSOS", 0.9, 0.9);

draw_set_color(c_white);
scr_desenhar_texto_ui(info_panel_x + 15, info_panel_y + 40, "Dinheiro: $" + string(global.dinheiro), 0.8, 0.8);
...
draw_set_color(c_white);
scr_desenhar_texto_ui(info_panel_x + 15, slot_bar_y + 15, "Slots: " + string(global.slots_pesquisa_usados) + "/" + string(global.slots_pesquisa_total), 0.75, 0.75);
...
for (var i = 0; i < array_length(research_names); i++) {
    ...
    scr_desenhar_texto_ui(card_x + card_w/2, card_y + 50, display_name, 0.8, 0.8);
    ...
    draw_set_alpha(1);
    scr_desenhar_texto_ui(card_x + card_w/2, status_y + 5, status_text, 0.65, 0.65);
}
...
if (global.slots_pesquisa_total == 3) {
    ...
    draw_set_alpha(1);
    scr_desenhar_texto_ui(slot_btn_x + slot_btn_w/2, slot_btn_y + slot_btn_h/2, "SLOT EXTRA ($" + string(global.custo_slot_extra) + ")", 0.85, 0.85);
}
...
draw_set_color(c_white);
draw_set_alpha(1);
scr_desenhar_texto_ui(close_btn_x + close_btn_w/2, close_btn_y + close_btn_h/2, "FECHAR", 0.85, 0.85);

// === INSTRUÇÕES ===
draw_set_halign(fa_center);
draw_set_color(make_color_rgb(200, 220, 255));
scr_desenhar_texto_ui(container_x + container_w/2, footer_y + 45, "Clique nos recursos para iniciar a pesquisa • Máximo " + string(global.slots_pesquisa_total) + " pesquisas simultâneas", 0.75, 0.75);
