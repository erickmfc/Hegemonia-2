...
if (mouse_check_button_pressed(mb_left) && _clique_detectado) {
    show_debug_message("✅ CLIQUE NA CASA DETECTADO!");
    
    // Por enquanto, apenas mostrar informações da casa
    show_debug_message("🏠 Casa clicada - ID: " + string(id));
    show_debug_message("📍 Posição: (" + string(x) + ", " + string(y) + ")");
    
    // TODO: Implementar funcionalidade específica da casa
    // Por exemplo: mostrar informações de população, recursos, etc.
}
